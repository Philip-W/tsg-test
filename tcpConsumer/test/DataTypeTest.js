...
let Header = require('../src/DataTypes/Header').Header;
let Event = require('../src/DataTypes/Event').Event;
let Market = require('../src/DataTypes/Market').Market;
let Outcome = require('../src/DataTypes/Outcome').Outcome;
